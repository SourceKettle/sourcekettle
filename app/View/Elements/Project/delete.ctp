...
/**
 *
 * Page for deletion confirmation in the SourceKettle system
 *
        ...
        <div class="row-fluid">
                <div class="well span8 offset2 deletable">
                    <?php
                        echo "<h4>";
                        if (sizeof($objects) < 1) {
                            echo "Deleting '".h($object['name'])."' is irreversible!";
                        } else {
                            echo "If you delete '".h($object['name'])."' you will also be deleting:";
                        }
                        echo "</h4>";
