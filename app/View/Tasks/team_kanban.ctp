...
<div class="row-fluid">
        ...
        <?= $this->element('Task/Board/column',
            array('tasks' => $open, 'status' => 'open', 'title' => __('Open'), 'span' => '3', 'task_span' => 12, 'classes' => 'sprintboard-column', 'draggable' => false)
        ) ?>

        <?= $this->element('Task/Board/column',
            array('tasks' => $inProgress, 'status' => 'in progress', 'title' => __('In Progress'), 'span' => '3', 'task_span' => 12, 'classes' => 'sprintboard-column', 'draggable' => false)
        ) ?>
        <?= $this->element('Task/Board/column',
            array('tasks' => $resolved, 'status' => 'resolved', 'title' => __('Resolved'), 'span' => '3', 'task_span' => 12, 'classes' => 'sprintboard-column', 'draggable' => false)
        ) ?>
        <?= $this->element('Task/Board/column',
            array('tasks' => $closed, 'status' => 'closed', 'title' => __('Closed'), 'span' => '3', 'task_span' => 12, 'classes' => 'sprintboard-column', 'draggable' => false)
        ) ?>
