...
<?=__("You have been invited to join %s by one of our users.", $this->Html->link($sourcekettle_config['UserInterface']['alias'], array('/')))?>
...
<?=__("If you are not expecting a Sourcekettle invitation, then please just ignore this e-mail.")?>
