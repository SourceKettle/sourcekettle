...
<div class="row-fluid">
	...
	<div class="well span10 offset1">
		...
		<pre>git clone <?= $sourcekettle_config['SourceRepository']['user']['value'] ?>@<?= gethostname() ?>:projects/<?= h($project['Project']['name']) ?>.git</pre>
...
git remote add origin <?= $sourcekettle_config['SourceRepository']['user']['value'] ?>@<?= gethostname() ?>:projects/<?= h($project['Project']['name']) ?>.git
