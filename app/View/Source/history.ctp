...
/**
 *
 * View class for APP/Source/history for the DevTrack system
 * Allows users to view history for a file
 *
            ...
            <div class="span10">
                <div class="well">
                    <div class="row-fluid">
                        ...
                        <div class="span2">
                            <?= $this->Bootstrap->button_link('See File', array_merge(array('project' => $project['Project']['name'], 'action' => 'tree', $commit['Commit']['hash']), explode('/', $path)), array("style" => "info", "class" => "pull-right")) ?>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span10">
                            <h6>
                                <span class="label label-success">Added</span> <span class="green_front"><?= $commit['Commit']['diff'][$path]['more'] ?></span>
                                <span class="label label-important">Deleted</span> <span class="red_front"><?= $commit['Commit']['diff'][$path]['less'] ?></span>
                            </h6>
                        </div>
                    </div>
                    <br>
                    ...
                    <?php
                        foreach ($commit['Commit']['diff'][$path]['hunks'] as $a => $hunk) {
                            $d_m = $commit['Commit']['diff'][$path]['hunks_def'][$a]['-'];
                            $d_a = $commit['Commit']['diff'][$path]['hunks_def'][$a]['+'];
                            ?>
                            <tr class="diff_row">
