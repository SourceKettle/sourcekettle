...
<div class="row-fluid">
	<div class="well">
		...
		<pre><?= $sourcekettle_config['SourceRepository']['user']['value'] ?>@<?= gethostname() ?>:projects/my-project-name.git</pre>
		</p>
		<p>
...
<div class="row-fluid">
	<div class="well">
		...
		<pre>git checkout <?= $sourcekettle_config['SourceRepository']['user']['value'] ?>@<?= gethostname() ?>:projects/my-project-name.git</pre>
