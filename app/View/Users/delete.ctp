...
<div class="row">
    ...
    <div class="span6">
        ...
        <h3>Problem?</h3>
        <p>
          If you think something's gone horribly wrong and you really <strong>should</strong> be able to delete your account, it's probably worth having a chat with <?= $this->Html->link('the system administrator', 'mailto:'.$sourcekettle_config['Users']['sysadmin_email']['value']) ?>!
        </p>
        </div>
    </div>
    <? else: ?>
