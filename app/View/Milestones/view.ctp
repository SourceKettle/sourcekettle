...
<div class="row-fluid">
	<?= $this->element('Task/Board/column',
		array('tasks' => $dropped, 'status' => 'dropped', 'title' => __("Deferred tasks"), 'tooltip' => __('Tasks that we did not have time for, we will work on them in a later milestone'), 'span' => '12', 'task_span' => 4, 'classes' => 'sprintboard-icebox', 'draggable' => $hasWrite)
	) ?>
