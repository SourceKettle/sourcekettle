...
class AppController extends Controller {
     ...
     * @var type
     */
    public $helpers = array('Html', 'Text', 'Session', 'Form', 'Bootstrap' => array('className' => 'TwitterBootstrap.TwitterBootstrap'), 'Popover', 'TwitterBootswatch.TwitterBootswatch', 'Gravatar');
