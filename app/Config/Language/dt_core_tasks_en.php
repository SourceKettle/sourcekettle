...
$config['dtcore']['pages']['tasks']['index']['en']['column.options.statuses.active'] = "Active";
...
$config['dtcore']['pages']['tasks']['add']['en']['form.assignee.label'] = "Assigned to";
$config['dtcore']['pages']['tasks']['add']['en']['form.dependent_tasks.label'] = "Depends on";
